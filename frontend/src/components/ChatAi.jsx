/* COMPONENT: ChatAi
   PURPOSE: Interface for the AI assistant. Handles message streaming and user prompts.
*/
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%", minHeight: 400 }}>
      <style>{`
        ...
        .chat-avatar.bot { background:var(--accent-bg); border:1px solid var(--accent-border); color:var(--accent); }
        ...
        .chat-bubble.user { background:var(--accent-bg); border:1px solid var(--accent-border); color:#e0e0e0; border-radius:12px 4px 12px 12px; }
        ...
        @keyframes chat-bounce { 0%,60%,100% { transform:translateY(0); } 30% { transform:translateY(-6px); background:var(--accent); } }
        ...
        .chat-send { background:var(--accent); border:none; border-radius:9px; width:38px; height:38px; display:flex; align-items:center; justify-content:center; cursor:pointer; color:#fff; transition:opacity 0.2s; flex-shrink:0; }
